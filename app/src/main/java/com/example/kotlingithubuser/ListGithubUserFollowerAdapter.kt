...
import com.example.kotlingithubuser.databinding.ItemRowGithubUserFollowersBinding

class ListGithubUserFollowerAdapter : RecyclerView.Adapter<ListGithubUserFollowerAdapter.ListViewHolder>() {
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding = ItemRowGithubUserFollowersBinding.bind(itemView)
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, index: Int): ListViewHolder {
        val mView = LayoutInflater.from(viewGroup.context).inflate(R.layout.item_row_github_user_followers, viewGroup, false)
